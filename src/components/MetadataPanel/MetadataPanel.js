...
class MetadataPanel extends Component {
  ...
  async handleNameSave() {
    ...
    const nameChangeSuccessful = await this.props.handleDatasetNameChange(this.state.editedName);
      ...
      <div className="sidepanel-card">
        ...
        <CardBody>
          <div className="customMetaDataItem">
            ...
            <div className={`customMetaDataItem_value ${this.state.nameEditActive ? 'editing' : ''}`}>
              {this.state.nameEditActive ? (
                  ...
                  <FormGroup>
                    <InputGroup className="datasetNameChangeInputArea">
                      ...
                      <InputGroupAddon addonType="append">
                        <button className='confirmDatasetNameButton' onClick={this.handleNameSave}>
                ...
                <>
                  ...
                  <button className="changeDatasetNameButton" onClick={this.handleNameEditButtonClick}>
          ...
          {this.metaDataItem(
            'Start',
            this.props.start !== undefined ? unixTimeToString(this.props.start) : ''
          )}
          {this.metaDataItem(
            'End',

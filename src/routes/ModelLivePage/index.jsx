    ...
    <>
      {toastVisible ? (
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, display: "flex", justifyContent: "center" }}>
          <Notification color="red" title="Warning!" onClose={() => setToastVisible(false)}>
            Device disconnected!
          </Notification>
        </div>
      ) : null}
      ...
      >
        <div style={{ paddingLeft: "0.5rem", paddingRight: "0.5rem", paddingBottom: "0.5rem", paddingTop: "1rem" }}>
          <h4 style={{ fontWeight: 700 }}>{"LIVE MODEL"}</h4>
          <div style={{ display: "flex", justifyContent: "flex-start", margin: "0.5rem" }}>
              ...
              <div>
                <h5 style={{ display: "flex", alignItems: "center" }}>
                  ...
                  {model.labels.map((elm) => (
                    <LabelBadge key={elm._id} style={{ margin: "0.25rem" }} color={elm.color}>
                      {elm.name}
                    </LabelBadge>
                  ))}
                </h5>
